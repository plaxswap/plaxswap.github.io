...
const STABLESWAP_SUBGRAPH_ENDPOINT = 'https://api.studio.thegraph.com/query/111480/plaxio/version/latest'
...
const INFO_CLIENT_WITH_CHAIN = {
  [ChainId.BSC]: 'https://api.studio.thegraph.com/query/111480/plaxio/version/latest',
  [ChainId.BSC_TESTNET]: '',
}
