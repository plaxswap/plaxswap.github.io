...
import { ThemeContext as StyledThemeContext, DefaultTheme } from 'styled-components'
import Cookie from 'js-cookie'
import { COOKIE_THEME_KEY, THEME_DOMAIN } from 'hooks/useTheme'

const useThemeCookie = () => {
  const theme = useContext<DefaultTheme>(StyledThemeContext as Context<DefaultTheme>)
