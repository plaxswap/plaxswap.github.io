  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active PancakeSwap Profile to buy Minting Tickets and mint a Plaxswap Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold PLASA'),
      bodyText: [t('Each NFT costs PLASA to mint. Remember you also need MATIC to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
